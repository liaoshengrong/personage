  ...
  return (
    <div className="mt-8 xs:mt-3 animate__animated animate__fadeInUp grid grid-cols-2 gap-3">
      <div className="border border-gray-400 p-4 rounded-lg">
        ...
        {/* <div className="mt-4 w-28 flex justify-center py-3 cursor-pointer mx-auto border border-gray-600 active:bg-slate-400">
          点击抽奖
        </div> */}
        <div className="flex justify-center mt-3">
          <Button onClick={onLottery}>点击抽奖</Button>
        </div>
        {/* <div>{count.number.to((n) => n.toFixed(0)).id}</div> */}
      </div>
    </div>
  );
};
