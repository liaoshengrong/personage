...
export const GROUPS: Record<GroupLetter, Team[]> = {
  ...
  D: [
    ...
    { name: '澳大利亚', fifa: 25, pts: 4 },
    { name: '巴拉圭', fifa: 37, pts: 4 },
    { name: '土耳其', fifa: 32, pts: 3 },
  ],
  E: [
    { name: '德国', fifa: 8, pts: 6 },
    { name: '科特迪瓦', fifa: 31, pts: 6 },
    { name: '厄瓜多尔', fifa: 30, pts: 4 },
    { name: '库拉索', fifa: 81, pts: 1 },
  ],
  F: [
    { name: '荷兰', fifa: 7, pts: 7 },
    { name: '日本', fifa: 16, pts: 5 },
    { name: '瑞典', fifa: 36, pts: 4 },
    { name: '突尼斯', fifa: 58, pts: 0 },
  ],
  G: [
    { name: '比利时', fifa: 10, pts: 5 },
    { name: '埃及', fifa: 26, pts: 5 },
    { name: '伊朗', fifa: 22, pts: 3 },
    { name: '新西兰', fifa: 84, pts: 1 },
  ],
  H: [
    { name: '西班牙', fifa: 3, pts: 7 },
    { name: '佛得角', fifa: 63, pts: 3 },
    { name: '乌拉圭', fifa: 19, pts: 2 },
    { name: '沙特阿拉伯', fifa: 59, pts: 2 },
  ],
  I: [
    { name: '法国', fifa: 2, pts: 9 },
    { name: '挪威', fifa: 27, pts: 6 },
    { name: '塞内加尔', fifa: 17, pts: 3 },
    { name: '伊拉克', fifa: 60, pts: 0 },
  ],
  J: [
    { name: '阿根廷', fifa: 1, pts: 9 },
    { name: '奥地利', fifa: 21, pts: 4 },
    { name: '阿尔及利亚', fifa: 29, pts: 4 },
    { name: '约旦', fifa: 68, pts: 0 },
  ],
  K: [
    { name: '哥伦比亚', fifa: 12, pts: 7 },
    { name: '葡萄牙', fifa: 9, pts: 5 },
    { name: '民主刚果', fifa: 43, pts: 4 },
    { name: '乌兹别克斯坦', fifa: 54, pts: 0 },
  ],
  L: [
    { name: '英格兰', fifa: 4, pts: 7 },
    { name: '克罗地亚', fifa: 15, pts: 6 },
    { name: '加纳', fifa: 65, pts: 4 },
...
export const FIXTURES: Record<GroupLetter, Fixture[]> = {
  ...
  D: [
    ...
    { home: '土耳其', away: '美国', date: '06-25', md: 3, played: true, score: '3-2' },
    { home: '巴拉圭', away: '澳大利亚', date: '06-25', md: 3, played: true, score: '0-0' },
  ],
  E: [
    ...
    { home: '库拉索', away: '科特迪瓦', date: '06-25', md: 3, played: true, score: '0-2' },
    { home: '厄瓜多尔', away: '德国', date: '06-25', md: 3, played: true, score: '2-1' },
  ],
  F: [
    ...
    { home: '日本', away: '瑞典', date: '06-25', md: 3, played: true, score: '1-1' },
    { home: '突尼斯', away: '荷兰', date: '06-25', md: 3, played: true, score: '1-3' },
  ],
  G: [
    ...
    { home: '埃及', away: '伊朗', date: '06-26', md: 3, played: true, score: '1-1' },
    { home: '新西兰', away: '比利时', date: '06-26', md: 3, played: true, score: '1-5' },
  ],
  H: [
    ...
    { home: '佛得角', away: '沙特阿拉伯', date: '06-26', md: 3, played: true, score: '0-0' },
    { home: '乌拉圭', away: '西班牙', date: '06-26', md: 3, played: true, score: '0-1' },
  ],
  I: [
    ...
    { home: '挪威', away: '法国', date: '06-26', md: 3, played: true, score: '1-4' },
    { home: '塞内加尔', away: '伊拉克', date: '06-26', md: 3, played: true, score: '5-0' },
  ],
  J: [
    ...
    { home: '阿尔及利亚', away: '奥地利', date: '06-27', md: 3, played: true, score: '3-3' },
    { home: '约旦', away: '阿根廷', date: '06-27', md: 3, played: true, score: '1-3' },
  ],
  K: [
    { home: '葡萄牙', away: '民主刚果', date: '06-17', md: 1, played: true, score: '1-1' },
    { home: '乌兹别克斯坦', away: '哥伦比亚', date: '06-17', md: 1, played: true, score: '1-3' },
    { home: '葡萄牙', away: '乌兹别克斯坦', date: '06-23', md: 2, played: true, score: '5-0' },
    { home: '哥伦比亚', away: '民主刚果', date: '06-23', md: 2, played: true, score: '1-0' },
    { home: '哥伦比亚', away: '葡萄牙', date: '06-27', md: 3, played: true, score: '0-0' },
    { home: '民主刚果', away: '乌兹别克斯坦', date: '06-27', md: 3, played: true, score: '3-1' },
  ],
  L: [
    { home: '英格兰', away: '克罗地亚', date: '06-17', md: 1, played: true, score: '4-2' },
    { home: '加纳', away: '巴拿马', date: '06-17', md: 1, played: true, score: '1-0' },
    { home: '英格兰', away: '加纳', date: '06-23', md: 2, played: true, score: '0-0' },
    { home: '巴拿马', away: '克罗地亚', date: '06-23', md: 2, played: true, score: '0-1' },
    { home: '巴拿马', away: '英格兰', date: '06-27', md: 3, played: true, score: '0-2' },
    { home: '克罗地亚', away: '加纳', date: '06-27', md: 3, played: true, score: '2-1' },
  ],
};
