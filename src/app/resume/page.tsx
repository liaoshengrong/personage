      ...
      <div className="max-w-5xl mx-auto bg-white shadow-2xl xs:shadow-none rounded-lg overflow-y-auto overflow-x-hidden mt-8 xs:mt-0 animate__animated animate__fadeInUp">
        <div className="p-8 xs:p-5">
          ...
          <header className="mb-10 border-b pb-4 xs:mb-5">
            <h1 className="text-4xl font-bold text-gray-800 xs:text-lg">
              廖声荣
            </h1>
            <p className="mt-2 text-lg xs:text-sm xs:mt-1 text-gray-600">
              26岁丨4年 前端
            </p>
            <p className="mt-2 text-lg xs:text-sm xs:mt-1 text-gray-600">
              📧 14796743426@163.com
            </p>
            <p className="mt-2 text-lg xs:text-sm xs:mt-1">
              博客:{" "}
              <a
          ...
          {/* 个人技能 */}
          <section className="mb-10 xs:mb-5">
            <h2 className="text-2xl xs:text-base font-semibold text-gray-700 border-b pb-2 mb-4">
              🔧 个人技能
            </h2>
            <ul className="list-disc list-inside space-y-2 text-gray-600">
              <li className="leading-6 xs:text-sm xs:leading-5">
          ...
          <section className="mb-10">
            ...
            <div className="mb-8 xs:mb-4">
              ...
              <p className="text-gray-500 xs:text-sm">
                前端开发工程师 (2022.8 - 2024.9)
              </p>
              <ul className="list-disc list-inside space-y-2 mt-2 text-gray-600 xs:text-sm">
                <li className="leading-6 xs:leading-5">
          ...
          <section>
            ...
            <div>
              ...
              <p className="mt-2 text-gray-600 xs:mt-1 xs:text-sm xs:leading-5">
