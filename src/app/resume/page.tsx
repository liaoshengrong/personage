        ...
        <div className="p-8">
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-600">
              ...
              <li>熟悉使用 jest 编写 vm 层的 unit test。</li>
              <li>
                熟悉使用 Webpack、Vite
          ...
          <section className="mb-10">
            ...
            {/* 中电金信软件 */}
            <div>
              <h3 className="text-xl font-bold text-gray-800">中电金信软件</h3>
          ...
          <section className="mb-10">
            ...
            {/* 8c Game 平台 */}
            <div className="mb-8">
              <h3 className="text-xl font-bold text-gray-800">8c Game 平台</h3>
            ...
            {/* Wealth */}
            <div className="mb-8">
              <h3 className="text-xl font-bold text-gray-800">Wealth</h3>
              <p className="text-gray-500">
            ...
            {/* Wealth admin */}
            <div className="mb-8">
              <h3 className="text-xl font-bold text-gray-800">Wealth admin</h3>
            ...
            {/* Ko咖啡小程序 */}
            <div className="mb-8">
              <h3 className="text-xl font-bold text-gray-800">Ko咖啡小程序</h3>
          ...
          <section>
            ...
            <div className="mb-6">
              <h3 className="text-xl font-bold text-gray-800">南昌教育学院</h3>
              <p className="text-gray-500">大专 (2017.09 - 2020.07)</p>
            </div>
            <div>
              <h3 className="text-xl font-bold text-gray-800">西南科技大学</h3>
              <p className="text-gray-500">
